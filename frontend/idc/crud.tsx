...
export const createCrudOptions = function ({ crudExpose }: CreateCrudOptionsProps): CreateCrudOptionsRet {
  ...
  return {
    crudOptions: {
      ...
      actionbar: { buttons: { add: { show: hasAuth('idc:Create') } } },
      rowHandle: {
        buttons: {
          edit: { show: compute(() => hasAuth('idc:Update')) },
          remove: { show: compute(() => hasAuth('idc:Delete')) },
        },
      },
      columns: {
        _index: {
        ...
        name: {
          title: '机房名称',
          type: 'input',
          search: { show: true, component: { placeholder: '请输入机房名称' } },
          form: { rules: [{ required: true, message: '请输入机房名称' }], component: { placeholder: '请输入机房名称' } },
          column: { minWidth: 140 },
        },
        code: {
          title: '机房编码',
          type: 'input',
          search: { show: true },
          form: { component: { placeholder: '请输入机房编码' } },
          column: { minWidth: 110 },
        },
        location: {
          title: '位置',
          type: 'input',
          form: { component: { placeholder: '请输入机房位置' } },
          column: { minWidth: 140 },
        },
        sort: {
          title: '排序',
