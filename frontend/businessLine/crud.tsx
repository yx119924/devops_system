...
export const createCrudOptions = function ({ crudExpose }: CreateCrudOptionsProps): CreateCrudOptionsRet {
  ...
  return {
    crudOptions: {
      ...
      actionbar: { buttons: { add: { show: hasAuth('businessLine:Create') } } },
      rowHandle: {
        buttons: {
          edit: { show: compute(() => hasAuth('businessLine:Update')) },
          remove: { show: compute(() => hasAuth('businessLine:Delete')) },
        },
      },
      columns: {
        _index: {
        ...
        name: {
          title: '业务线名称',
          type: 'input',
          search: { show: true, component: { placeholder: '请输入业务线名称' } },
          form: { rules: [{ required: true, message: '请输入业务线名称' }], component: { placeholder: '请输入业务线名称' } },
          column: { minWidth: 140 },
        },
        code: {
          title: '业务线编码',
          type: 'input',
          search: { show: true },
          form: { component: { placeholder: '请输入业务线编码' } },
          column: { minWidth: 110 },
        },
        owner: {
          title: '负责人',
          type: 'input',
          search: { show: true },
          form: { component: { placeholder: '请输入负责人' } },
          column: { minWidth: 110 },
        },
        sort: {
          title: '排序',
